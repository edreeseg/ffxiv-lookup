                    ...
                    : (
                        <div>
                            ...
                            <Equipment
                                ...
                                hands={this.props.gear.filter(x => x.item.item_uicategory.name === 'Hands')[0]}
                                body={this.props.gear.filter(x => x.item.item_uicategory.name === 'Body')[0]}
                                waist={this.props.gear.filter(x => x.item.item_uicategory.name === 'Waist')[0]}
                                legs={this.props.gear.filter(x => x.item.item_uicategory.name === 'Legs')[0]}
                                feet={this.props.gear.filter(x => x.item.item_uicategory.name === 'Feet')[0]}
                                ring1={this.props.gear.filter(x => x.item.item_uicategory.name === 'Ring')[0]}
                                ring2={this.props.gear.filter(x => x.item.item_uicategory.name === 'Ring')[1]}
                                necklace={this.props.gear.filter(x => x.item.item_uicategory.name === 'Necklace')[0]}
                                bracelets={this.props.gear.filter(x => x.item.item_uicategory.name === 'Bracelets')[0]}
